...
The goal is not only learning APIs, but understanding:
...
## 04. Transformers
- [Attention Mechanism](./04-transformers/attention.ipynb)
...
## Production AI
- [LLM Cost Optimization](./production/llm-cost-optimization.ipynb)
- [Hallucination Debugging](./production/hallucination-debugging.ipynb)
- [Context Engineering](./production/context-engineering.ipynb)
- [Prompt Versioning](./production/prompt-versioning.ipynb)
- [Evaluation](./production/evaluation.ipynb)
- [Caching Strategies](./production/caching.ipynb)
- [GPU Inference](./production/gpu-inference.ipynb)
- [Quantization](./production/quantization.ipynb)
